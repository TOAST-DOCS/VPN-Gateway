...
* Between Korea (Pyeongchon) region, Korea (Pangyo) region, and Korea (Gwangju) Region, you can also use a VPN to connect (peer gateway devices in each region must be selected from Fortinet).
